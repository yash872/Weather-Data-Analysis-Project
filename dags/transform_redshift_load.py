...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assets-010526265053-us-east-1/scripts/weather_data_ingestion.py',
    s3_bucket='s3://aws-glue-assets-010526265053-us-east-1/',  # S3 bucket where logs and local etl script will be uploaded
    aws_conn_id='aws_default',  # You'll need to set up an AWS connection in Airflow
    region_name="us-east-1",
    iam_role_name='AWSGlueServiceRole-fullAccess',
